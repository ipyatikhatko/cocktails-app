...
const NavBar = (props: Props) => {
  return (
    <nav className="xs:pt-5 xs:px-4 h-[8vh] xs:h-[10vh]  w-full flex items-center fixed top-0 left-0 z-[55]">
      <div className="flex items-center px-2 xs:px-3 lg:max-w-screen-xl mx-auto w-full h-full xs:rounded-xl xs:shadow-md shadow-black/70 backdrop-blur-sm bg-gradient-to-tl from-lime-200 to-teal-400">
        <TextField
